...
import { jsRect, rect_includes } from './geometry.js';
import { draw_rect_R } from './graphics.js';
import { g_pictureCanvas, g_pointManager } from './index.js';
import { generateTool } from './oebi-tool.js';
import {
  modify_click_event_to_end_in_place, PointingEvent,
  PointingEventClone,
  VirtualClickEvent
